# Start Route 53 Record for old.aorlowski.com to have an A Record to the CloudFront distribution
...
# End Route 53 Record for old.aorlowski.com to have an A Record to the CloudFront distribution
...
resource "aws_route53_record" "aorlowski_cloudfront_record" {
    ...
    records = [local.local.vercel_dns_ip_str]

    allow_overwrite = true
}
# End Route 53 Record for aorlowski.com to have an A Record to Vercel

# Start Route 53 Record for www.aorlowski.com to have an A Record to Vercel
...
# End Route 53 Record for www.aorlowski.com to have an A Record to Vercel
